...
API_KEY = "lW4FdOHqztBaWU-Elwlea5sTKSbBnPy3LWI-qR5pwCfw"
...
def evaluate():
    ...
    response_scoring = requests.post(
        'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/690e3a4b-9213-4107-ae28-711d175b17dc/predictions?version=2022-11-18',
    ...
    return render_template("success.html",predict=predict)
